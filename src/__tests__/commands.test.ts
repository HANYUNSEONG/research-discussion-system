...
describe("rds commands", () => {
  ...
  test("codex install and uninstall manage local skill integration", () => {
    withTempProject((dir, _project) => {
      ...
      expect(fs.existsSync(path.join(home, ".agents", "skills", "rds-setup", "SKILL.md"))).toBe(true);
      ...
      expect(fs.existsSync(path.join(home, ".agents", "skills", "rds-setup", "SKILL.md"))).toBe(false);
    });
  });
});
