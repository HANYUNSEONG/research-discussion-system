...
import { ensureDir, exists, isNonEmptyDir, localDate, readText, resolvePath, toPosix, walkFiles, writeText, } from "../lib/files.js";
import { fail } from "../lib/errors.js";
export const SCAFFOLD_FOLDERS = {
...
function copyTemplateTree(source, target, values, includeGlossary) {
...
export function scaffoldCommand(argv, repoRoot, cwd = process.cwd()) {
